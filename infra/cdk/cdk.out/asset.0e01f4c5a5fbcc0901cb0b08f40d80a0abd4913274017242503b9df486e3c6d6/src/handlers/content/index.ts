/**
 * Content domain Lambda handler.
 *
 * Registers routes tagged with 'content', 'subjects', 'progress', or 'revision'
 * and dispatches API Gateway proxy events through the shared ApiRouter.
 */
...
const DOMAIN_TAGS = ['content', 'subjects', 'progress', 'revision'];
