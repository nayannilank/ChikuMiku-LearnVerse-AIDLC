...
| 6 | Relationship | Dropdown; Options: **Father**, **Mother**, **Other** |
...
| 6 | Grade | Dropdown: LKG, UKG, First, Second, Third, Fourth, Fifth, Sixth, Seventh, Eighth, Ninth, Tenth, Eleventh, Twelfth |
| 7 | School Name | 5–30 characters; allowed: alphabets, numbers, commas, hyphens |
| 8 | Subject Selection | 7 default subjects displayed as selectable icons; **all selected by default** |
| 9 | Add Subject | Parent can create a custom subject (1–50 characters) added to the selectable list |
...
| Settings | Manage Students, Profile, Add Subject |
